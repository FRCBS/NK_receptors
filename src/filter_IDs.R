...
nc_IDs <- fread("./results/pgen_NK_SNPs/newcastle_plink_pgen.psam")
pol_IDs <- fread("./results/pgen_NK_SNPs/poland_plink_pgen.psam")
...
write.table(remove_all, file="./results/pgen_NK_SNPs/individuals_to_remove.txt", sep="\t", quote=F, row.names=F, col.names=F)
